...
public class UtilTest {
    ...
    public void testMoveImmutable() {
        ...
        CellValue moved = Util.moveImmutably(value, 1, 1, 100, 100);
        Assert.assertEquals(value.getEditorValue(), "=A1");
    ...
    public void testMoveFixedExpression() {
        ...
        Util.move(fixed, 1, 1, 100, 100);
        Util.move(columnFixed, 1, 1, 100, 100);
        Util.move(rowFixed, 1, 1, 100, 100);
